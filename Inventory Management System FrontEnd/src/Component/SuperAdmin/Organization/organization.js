...
function createData(id , image , name, Location, Email, ContactNumber ,Action) {
  return { id , image, name, Location, Email , ContactNumber, Action : renderActionLink(id) };
}
...
const rows = [
  ...
  createData('5', 'Null', 'Gigalabs', 'Lahore' , 'gigalabs5@gmail.com' , '03037869032' ,'View'),
  createData('6', 'Null', 'Gigalabs', 'Lahore' , 'gigalabs6@gmail.com' , '0306739032' ,'View'),
  createData('7', 'Null', 'Gigalabs', 'Lahore' , 'gigalabs7@gmail.com' , '03089359232' ,'View'),
  createData('8', 'Null', 'Gigalabs', 'Lahore' , 'gigalabs8@gmail.com' , '03327139132' ,'View'),
  createData('9', 'Null', 'Gigalabs', 'Lahore' , 'gigalabs9@gmail.com' , '03371259892' ,'View'),
  createData('10', 'Null', 'Gigalabs', 'Lahore' , 'gigalab10s@gmail.com' , '03067212032' ,'View'),
  createData('11', 'Null', 'Gigalabs', 'Lahore' , 'gigalabs11@gmail.com' , '03067317632' ,'View'),
    ...
    <Paper sx={{margin : 'auto' , width : '95%' }}>
      ...
      <TableRow>
              <TableCell style={{ display : 'flex' , alignItems : 'center' , justifyContent : 'center',  color: 'fff',fontSize:'16px'}}>
                <Typography variant='h5' sx={{marginRight : '10px', marginLeft:'-10px' ,fontWeight : 'bold'}}>Organization</Typography>
                <Paper
                    component="form"
              ...
              <Button variant="contained" color="success" size='medium' sx={{marginLeft : '26rem', width :'50px' , height:'37px'}} 
              startIcon={<AddIcon sx={{color:'#fff' , marginTop:'18px',marginLeft:'5px' , marginRight:'-5px'}}/>}>
                 <a className='add' href="/create">Add</a>
              </Button>
