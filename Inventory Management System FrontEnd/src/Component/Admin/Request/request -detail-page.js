import {Box, Button, Divider, FormControl, Paper, Typography } from "@mui/material";
import ArrowBackIcon from '@mui/icons-material/ArrowBack';
import "../../createOrganization.css";
import PhotoIcon from '@mui/icons-material/Photo';
import React from "react";
import { photoIcon } from "../Employee/emplyeeStyle";
import { paperStyle } from "./requestStyle";
import { addButton, addIcon, backIconStyle, boxStyle, descBox, dividerStyle, innerBox, mainBox, statusButton } from "../Inventory/inventoryStyle";
    ...
    return (
        <Paper sx={paperStyle}>
            <Box sx={boxStyle}>
                ...
                <h2><span>Back</span>Request-ID : 14532</h2>
                <Button variant="contained" color="primary" size='small' sx={addButton}>
                <a href="add" className='add' >Pendings</a>
                </Button>
                <Typography sx={{marginLeft : '1rem' , marginRight :'18rem'}} >Submission Date : 19/04/2023</Typography>
                <Button variant="contained" color="error" size='small' sx={statusButton}>
                <Link to="/requests" className='add' >Reject Request</Link>
                </Button>
                <Button variant="contained" color="success" size='small' sx={statusButton}>
                <Link to="/requests" className='add' >Approve Request</Link>
                </Button>
